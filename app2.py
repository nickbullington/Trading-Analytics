...
date = clean_df['report_date'].sort_values().iloc[0]
st.download_button(f'Raw Historical Export Inspections Since {date.dt.date}', data=converted_data, file_name='wasde_df.csv', mime='text/csv')
